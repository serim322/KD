...
#stu_checkpoint = "/home/s1/serimkim/hf/distil-kobert-finetuned_distil_kobert_len10_epoch4/checkpoint-13000"
...
lm_datasets = datasets.load_from_disk("datasets_10")

# 훈련-테스트 데이터셋 분리
test_size = 3720317 // 10   # dataset row : 3720317
train_size = 3720317 - test_size
...
training_args = TrainingArguments(
    output_dir=f"{model_name}-finetuned_len10_epoch5",
...
trainer = Trainer(
    ...
    data_collator=lambda features: whole_word_masking_data_collator_with_padding(features, stu_tokenizer, 10, 1)
)
