...
lm_datasets = datasets.load_from_disk("lm_datasets_len_10")
...
# 훈련-테스트 데이터셋 분리
test_size = 6547297 // 10   # dataset row : 6547297
train_size = 6547297 - test_size
...
training_args = TrainingArguments(
    output_dir=f"{model_name}-finetuned-clinical-len10-1205",
